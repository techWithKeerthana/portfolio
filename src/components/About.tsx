  ...
  return (
    <section id="about" className="mx-auto w-full max-w-6xl px-4 py-16 sm:px-6 sm:py-20 md:px-10">
      <motion.div
        ...
        className="rounded-[2rem] border border-mistLine/30 bg-indigoSlate/55 p-6 sm:p-8 md:p-12"
      >
        ...
        <p className="type-body mt-6 max-w-4xl text-[#D5E2F8]">
          {aboutData.summary}
        </p>

        <div className="mt-8 grid gap-4 sm:grid-cols-2">
          <article className="rounded-2xl border border-mistLine/30 bg-navy/45 p-5">
            <div className="flex items-center gap-3 text-ice">
              <BrainCircuit size={18} aria-hidden="true" className="text-tealSignal" />
              <h3 className="font-heading text-lg font-semibold">Intelligent Systems</h3>
            </div>
            <p className="mt-3 text-sm leading-relaxed text-[#C9D8F1]">
          ...
          <article className="rounded-2xl border border-mistLine/30 bg-navy/45 p-5">
            <div className="flex items-center gap-3 text-ice">
              <Code2 size={18} aria-hidden="true" className="text-tealSignal" />
